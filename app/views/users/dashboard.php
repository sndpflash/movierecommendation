    ...
    <form action="<?php echo URLROOT;?>/dashboard/addmovie" method="post">
        ...
        <div class="form-group">
            ...
            <ul class = "list-group">
                <li class="list-group-item active">Selected Movies will Appear Here:    <button type="button" class="btn btn-secondary ml-4 btn-sm" onclick="removeSelectedMovieItem()"> Remove </button></li>
